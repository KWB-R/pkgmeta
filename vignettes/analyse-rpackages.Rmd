...
pkgs_codemetar <- pkgmeta::create_pkg_codemeta(pkgs, paths$pkglib)
...
if(all(pkgs$name %in% installed.packages()[,"Package"])) {

pkgs_codemetar <-  pkgmeta::create_pkg_codemeta(pkgs, libpath = "/home/travis/R/Library")


pkgmeta::write_pkg_codemeta(pkgs_codemetar,"codemetar.json")
}
